export const MOCKS_RECETAS = `[{
    ...
    },
    {
		"id": 3,
		"nombre": "Falafel",
		"img": "http://falafel.com.es/img/falafel-141.jpg",
		"descripcion": "El falafel es una preparación gastronómica de origen árabe pero cada vez es más elaborada en todo el mundo porque además de ser sencilla, tiene un sabor excelente. Te vamos a dar la receta del falafel para que puedas poner un toque internacional en tu mesa y sorprender a los tuyos.",
		"cocinero": "John Doug",
		"likes": 7,
		"isGlutenFree": true,
